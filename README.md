...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>Dhanasekaran M</h1>
      <p>I'm <span class="typed" data-typed-items="Designer, Freelancer, Boxer, Developer"></span></p>
    </div>
  </section><!-- End Hero -->
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>dhanasekar21234@gmail.com</span></li>
...
In the realm of web development, I'm adept in HTML, CSS, and JavaScript, enabling me to build responsive websites and interactive web applications. I work with front-end frameworks like Bootstrap and React and ensure cross-browser compatibility. Additionally, I'm versed in version control with Git and prioritize web performance optimization, all while maintaining a strong focus on problem-solving and SEO best practices.</p>
          ...
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item pb-0">
              ...
              <ul>
                ...
                <li>80569 93147</li>
                <li>dhanasekar21234@gmail.com</li>
              </ul>
            </div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>DHANASEKAR</span></strong>
      </div>
      <div class="credits">
